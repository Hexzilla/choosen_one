...
function Team() {
  ...
  return (
    <motion.div
      ...
      exit={{ opacity: 0 }}
    >
      <div className=" md:flex md:flex-col w-5/6 mx-auto md:mt-10" style={{paddingBottom: '70px'}}>
        ...
        <div className="flex flex-wrap" style={{margin: '-30px'}}>
          {utilityCards.map((card) => (
            <div className="relative flex-col flex w-[400px]" style={{width: '33.33%', flexBasis: '33.33%', padding: '30px', minHeight:'200px'}}>
